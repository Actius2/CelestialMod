...
namespace CelestialMod
{
	...
	public static class CelestialModSubworldManager
	{
		...
		//Call this in ModCallCelestialMod.PostSetupContent()
		public static void Load()
		{
			...
			if (subworldLibrary != null)
			{
				object result = subworldLibrary.Call(
					"Register",
					/*Mod mod*/ ModContent.GetInstance<CelestialMod>(),
					...
					/*Action unload*/ null,
					/*ModWorld modWorld*/ ModContent.GetInstance<CelestialModWorld>()
					);
		...
		public static List<GenPass> MySubworldGenPassList()
		{
			List<GenPass> list = new List<GenPass>
			{
				...
				delegate (GenerationProgress progress)
				{
					...
					Main.rockLayer = Main.maxTilesY - 400; //Hides the cavern layer way out of bounds
				},
				1f),
				//Second pass
