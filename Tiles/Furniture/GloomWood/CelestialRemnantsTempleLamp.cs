...
namespace CelestialMod.Tiles.Furniture.GloomWood
{
	...
	internal class CelestialRemnantsTempleLamp : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 16, 48, ItemType<Items.Placeable.Furniture.GloomWood2.CelestialRemnantsTempleLampItem>());
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
			...
			var flameTexture = mod.GetTexture("Tiles/Furniture/GloomWood/CelestialRemnantsTempleLamp_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
