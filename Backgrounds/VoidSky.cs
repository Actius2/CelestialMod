...
namespace CelestialMod.Backgrounds
{
    public class VoidSky : CustomSky
    {
        ...
        readonly CelestialMod mod = CelestialMod.instance;

        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            Texture2D MeteorTexture = mod.GetTexture("Backgrounds/VoidMeteor");
            Texture2D SkyTex = mod.GetTexture("Backgrounds/VoidBg");
